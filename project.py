...
if choice == 'Object Classification':   
    ...
    with tab_confusion_matrix:
        ...
        st.image('image/2_Classes_CNN_CF.jpg', width = 500)
    with tab_classification_report:
        st.markdown('***Classification Report***')
        st.image('image/2_Classes_CNN_R.jpg', width = 600)
    ...
    with tab_confusion_matrix:
        st.markdown('***Confusion Matrix***')
        st.image('image/5_Classes_CNN_CF.jpg', width = 500)
    with tab_classification_report:
        st.markdown('***Classification Report***')
        st.image('image/5_Classes_CNN_R.jpg', width = 600)
    ...
    with tab_confusion_matrix:
        st.markdown('***Confusion Matrix***')
        st.image('image/5_Classes_pretrained_CF.jpg', width = 500)
    with tab_classification_report:
        st.markdown('***Classification Report***')
        st.image('image/5_Classes_pretrained_R.jpg', width = 600)
    ...
    with tab_report:
        ...
        st.markdown('***Classification Report***')
        st.image('image/2_classes_LSTM.jpg', width = 600)
    ...
    with tab_report:
        ...
        st.markdown('***Classification Report***')
        st.image('image/2_classes_phoBERT.jpg', width = 600)
    ...
    with tab_report:
        ...
        st.dataframe(df1)
        st.markdown('***Classification Report***')
        st.image('image/2_classes_extract_phoBERT.jpg', width = 600)
